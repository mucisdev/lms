            ...
            <div class="dropdown d-md-inline-block d-inline">
                <div class="mb-0 row">
                    ...
                    <div class="col-sm-10 col-12">
                        <select name="id_smt" id="id_smt" class="form-select" onchange="link_to(`<?= 'welcome/kelas/' . $overview['kode_prodi'] . '/' ?>`+this.options[this.selectedIndex].value)" style="min-width: 200px;">
            ...
            <div class="col-md-6 col-xxl-3 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col mt-0">
                                <h3 class="my-2"><?= $kls['nm_kls'] ?></h3>
                            </div>

                            <div class="col-auto">
                                <p class="text-muted my-2"><?= $kls['nm_smt'] ?></p>
                            </div>
                        </div>
                        <div class="mb-0">
...
<?php else : ?>
    <div class="row">
        <div class="col-12 mx-auto pt-5 text-center">
            <h1 class="text-center">Data kelas tidak ditemukan.</h1>
            <p class="lead text-center mb-4">Mungkin saat ini belum ada kelas yang dibuat.</p>
